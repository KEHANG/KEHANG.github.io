...
{: .srs_img}
![Alt text]({{ site.github.url }}/assets/ner_post/img/math-formulation-1.png){:width="100%"}
...
{: .srs_img}
![Alt text]({{ site.github.url }}/assets/ner_post/img/math-formulation-2.png){:width="100%"}
...
{: .srs_img}
![Alt text]({{ site.github.url }}/assets/ner_post/img/solver-1.png){:width="100%"}
...
{: .srs_img}
![Alt text]({{ site.github.url }}/assets/ner_post/img/solver-2.png){:width="100%"}
