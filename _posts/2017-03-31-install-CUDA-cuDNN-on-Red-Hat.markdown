...
{:.cuda_cudnn_img}
![Alt text]({{ site.github.url }}/assets/cuda_cudnn_post/img/cuda_download.png)
...
{:.cuda_cudnn_img}
![Alt text]({{ site.github.url }}/assets/cuda_cudnn_post/img/deviceQuery.png)
...
{:.cuda_cudnn_img}
![Alt text]({{ site.github.url }}/assets/cuda_cudnn_post/img/cudnn_download.png)
